...
public class SaveGameFactoryTests {
    ...
    @Test
    public void save_should_preserve_location_nane() throws IOException {
        //Arrange
        ...
        // Complex patterns, create a String String Dictionary Class variable
        ...
        //Act
        String path = target.save(g); // 'paths' are usually string
